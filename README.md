...
requires the pin at the working version **and** `lib/reqlog` byte-identical to the pristine wheel — patching
the installed copy, the wheelhouse, or the app code are workarounds (new checks: `file_matches`, `dirs_equal`).
