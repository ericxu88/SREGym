...
def _ensure_loaded() -> None:
    ...
    from sregym.faults import bad_dependency_pin, cron_write_lock, db_file_permissions, env_var_typo, ledger_divergence, rate_limit_misconfig, unapplied_migration  # noqa: F401
