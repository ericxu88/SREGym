...
def _ensure_loaded() -> None:
    ...
    from sregym.faults import bad_dependency_pin, cron_write_lock, db_file_permissions, disk_full, env_var_typo, ledger_divergence, rate_limit_misconfig, stale_secret, truncated_env, unapplied_migration  # noqa: F401
